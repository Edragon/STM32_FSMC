...
//		delay_ms(200);				  
//	}  	 
 	Show_Str(30,50,200,16,"mcudev STM32F4XX",16,0);				    	 
	Show_Str(30,70,200,16,"PICTURE show",16,0);				    	 
	Show_Str(30,90,200,16,"KEY0:NEXT KEY1:PREV",16,0);				    	 
	Show_Str(30,110,200,16,"WK_UP:PAUSE",16,0);				    	 
	Show_Str(30,130,200,16,"mcudev.taobao.com",16,0);				    	 
	Show_Str(30,150,200,16,"2015-08-15",16,0);
 	while(f_opendir(&picdir,"0:/PICTURE"))//打开图片文件夹
 	{	    
		Show_Str(30,170,240,16,"PICTURE  err!",16,0);
		delay_ms(200);				  
  ...
  while(totpicnum==NULL)//图片文件为0		
	...
	Show_Str(30,170,240,16,"Display...",16,0); 
	delay_ms(1500);
	piclib_init();										//初始化画图	   	   
	curindex=0;											//从0开始显示
